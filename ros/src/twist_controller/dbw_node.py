...
class DBWNode(object):
    def __init__(self):
        ...
        rospy.loginfo("type(vehicle_mass): %s, %f",
                      type(vehicle_mass), vehicle_mass)
        ...
        self.curr_twist_cmd = None
        self.target_twist_cmd = None
        self.throttle = 0.0
        self.brake = 0.0
        self.steering = 0.0
        self.hz = 50
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.curr_twist_cmd is not None and self.target_twist_cmd is not None:
                throttle, brake, steering = self.controller.control(
                    dbw_enable=self.dbw_enable,
